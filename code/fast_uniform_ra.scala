...
object Main {
  ...
  def main(args: Array[String]) = {
    val ra: Randomized_Algorithm.random_alg[Nat.nat] = Code_Test.fast_uniform_ra(two)
    val ra2: Coin_Space.coin_stream => Option[(Nat.nat, Coin_Space.coin_stream)] = Randomized_Algorithm.Rep_random_alg[Nat.nat](ra)
